...
st.set_page_config(page_title="Nhận dạng chữ số")
...
st.sidebar.header("Nhận dạng chữ số")
st.write("<h1 style='color: black;'>Nhận dạng chữ số</h1>",unsafe_allow_html=True)

if 'is_load' not in st.session_state:
    # load model
    model_architecture = 'D:/21133028_DaoLeHuyGiap_21133020_NguyenDucDuy/pages/chu_so/digit_config.json'
    model_weights = 'D:/21133028_DaoLeHuyGiap_21133020_NguyenDucDuy/pages/chu_so/digit_weight.h5'
